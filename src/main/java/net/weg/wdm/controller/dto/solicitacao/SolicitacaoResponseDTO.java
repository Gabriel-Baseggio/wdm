...
public record SolicitacaoResponseDTO(Usuario solicitante, Turma turma, List<Dispositivo> dispositivos, List<PeriodoResponseDTO> periodos, LocalDate inicio, LocalDate fim) {
}
